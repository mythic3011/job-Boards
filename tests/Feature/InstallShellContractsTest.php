...
BASH);
    ...
    public function test_combined_compose_requires_generated_obs_runtime_artifacts(): void
    {
        ...
        $this->assertStringContainsString('COMPAT_ENV_FILE="/workspace/.blue-team-vm/runtime/compat.shell.env"', $contents);
        ...
        $this->assertStringContainsString('export DB_DATABASE="$${DB_DATABASE:-jobs_boards}"', $contents);
        $this->assertStringContainsString('export DB_USERNAME="$${DB_USERNAME:-jobs_user}"', $contents);
        $this->assertStringContainsString('export DB_PASSWORD="$${DB_PASSWORD:-jobs_local_password}"', $contents);
        ...
        $this->assertStringContainsString('GRAFANA_POSTGRES_DATABASE: ${DB_DATABASE:-jobs_boards}', $contents);
        $this->assertStringContainsString('GRAFANA_POSTGRES_USER: ${DB_USERNAME:-jobs_user}', $contents);
        $this->assertStringContainsString('GRAFANA_POSTGRES_SECRET: ${DB_PASSWORD:-jobs_local_password}', $contents);
