 ...
 * @property string $registration_state
...
class User extends Authenticatable
{
    ...
    public const REGISTRATION_STATE_PENDING_2FA = 'pending_2fa';
    ...
    /**
     * Check if registration is waiting for required follow-up before full activation.
     */
    public function isRegistrationPending(): bool
    {
        return $this->registration_state === self::REGISTRATION_STATE_PENDING_2FA;
    }

    /**
     * Check if registration has reached the fully active lifecycle state.
     */
    public function isRegistrationActive(): bool
    {
        return $this->registration_state === self::REGISTRATION_STATE_ACTIVE;
    }
