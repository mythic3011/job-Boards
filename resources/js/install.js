...
(function () {
    ...
    class InstallWizard {
            ...
            return `
                <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
                    <div class="max-w-2xl w-full">
                        ...
                        <div class="bg-white rounded-2xl shadow-xl p-8" id="content"></div>
                    </div>
                </div>
            `;
        }
        ...
        getStepIndicatorHTML(stepNum) {
            ...
            const isComplete = this.step > stepNum;
            ...
            return `
                <div class="flex flex-col items-center">
                    <div class="w-10 h-10 rounded-full border-2 ${classes} flex items-center justify-center font-semibold text-sm transition-all duration-200">
                        ${content}
                    </div>
                    <span class="text-xs mt-2 font-medium ${isActive ? "text-indigo-600" : isComplete ? "text-green-600" : "text-gray-400"}">${label}</span>
                </div>
            `;
        }
        ...
        async setup2FA() {
            ...
            if (
                ...
                this.data.recoveryCodes.length === 0
            ) {
            ...
            $("#copy-2fa-secret")
                ...
                .on("click", () => {
                    ...
                    if (navigator.clipboard && navigator.clipboard.writeText) {
                        ...
                        window.toast.error("Clipboard not available.");
                    }
                });
        }
                    ...
                    .done((data) => {
                        ...
                        setTimeout(() => {
                            window.location.href =
                                data && data.success && data.redirect
                                    ? data.redirect
                                    : "/login";
                        }, 1000);
                    })
